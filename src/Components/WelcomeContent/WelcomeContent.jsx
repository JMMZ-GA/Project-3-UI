  ...
  return (
    <div className="video-container">
      ...
      <div className="main">
        ...
        <p>
        Discover hidden gems, wherever you are. The perfect way to explore different cities in a new way using maps to mark and upload your favorite "off the grid" places to share with others!{" "}
        </p>
